"""kahunapizzaph_29151 URL Configuration
...
admin.site.site_header = "KahunaPizzaPH"
admin.site.site_title = "KahunaPizzaPH Admin Portal"
admin.site.index_title = "KahunaPizzaPH Admin"

# swagger
api_info = openapi.Info(
    title="KahunaPizzaPH API",
    default_version="v1",
    description="API documentation for KahunaPizzaPH App",
)
